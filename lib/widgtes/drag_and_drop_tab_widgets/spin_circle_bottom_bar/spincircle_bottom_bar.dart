...
import 'package:prodwo_timesheet/widgtes/drag_and_drop_tab_widgets/spin_circle_bottom_bar/modals.dart';
...
class SpinCircleBottomBarHolder extends StatelessWidget {
  ...
  const SpinCircleBottomBarHolder(
      {Key key, this.bottomNavigationBar, this.child})
      : super(key: key);
...
class PrimaryCircle extends StatelessWidget {
  ...
  const PrimaryCircle({Key key, this.color, this.radius, this.circleItems})
      : super(key: key);
